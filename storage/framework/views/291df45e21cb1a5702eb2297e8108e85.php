...
<?php $component->withAttributes([]); ?>
    ...
    <div style="margin-bottom: 16px;">
        <img id="preview"
            src="<?php echo e(auth()->user()->profile_photo ? asset('storage/' . auth()->user()->profile_photo) : asset('images/default-avatar.png')); ?>"
            alt="Poza profil"
            width="150"
...
<?php endif; ?>
<?php /**PATH C:\Users\dmari\OneDrive\Desktop\example-app\todo-app\resources\views/profile/edit.blade.php ENDPATH**/ ?>